...
RSpec.describe ApplicationPolicy do
  ...
  context 'when current user is an admin' do
    ...
    it { is_expected.not_to permit(admin, record, :index?) }
    it { is_expected.not_to permit(admin, record, :show?) }
    it { is_expected.not_to permit(admin, record, :edit?) }
    it { is_expected.not_to permit(admin, record, :update?) }
    it { is_expected.not_to permit(admin, record, :new?) }
    it { is_expected.not_to permit(admin, record, :create?) }
    it { is_expected.not_to permit(admin, record, :destroy?) }
    it { is_expected.not_to permit(admin, record, :export?) }
  end
